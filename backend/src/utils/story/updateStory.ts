...
//Might want to delete storyId and storyProfileId from input to prevent changes to these //permanently assigned values
        ...
        const mySqlQuery = 'UPDATE story SET storyBody = :storyBody, storyCategoryId = :storyCategoryId, storyLocationCity = :storyLocationCity, storyLocationState =:storyLocationState,  storyTitle = :storyTitle WHERE storyId = :storyId';
